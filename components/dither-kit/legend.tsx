      ...
      {chart.names.map((name) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 font-mono text-[11px] text-slate-500 transition-opacity dark:text-slate-400",
              isClickable &&
                "pointer-events-auto cursor-pointer hover:text-slate-950 dark:hover:text-slate-50",
              dimmed && "opacity-40"
            )}
          >
            <span
