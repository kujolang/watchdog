...
assert.equal(dryRun.provider_catalog_id, 'watchdog-provider-catalog:2026-07-26');
...
assert.match(String(req1.pricing_source), /^openrouter-public-catalog:2026-07-26/);
