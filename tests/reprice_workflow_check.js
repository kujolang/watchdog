...
assert.equal(dryRun.provider_catalog_id, 'watchdog-provider-catalog:2026-09-13');
...
assert.match(String(req1.pricing_source), /^openrouter-public-catalog:2026-09-13/);
...
assert.deepStrictEqual(JSON.parse(auditRun.pricing_source), ['openrouter-public-catalog:2026-09-13', 'openrouter-public-catalog:2026-09-13#alias'], 'reprice audit should record the sources actually applied');
