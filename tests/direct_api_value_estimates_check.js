...
assert(providerCatalog.models['gpt-5.6-sol'].cache_write_input_rate_per_million === 6.25, 'Current Codex model cache-write pricing should come from OpenAI');
...
assert(catalog.catalog_id === 'openrouter-public-catalog:2026-08-23', 'Catalog snapshot should be versioned with the refresh date');
